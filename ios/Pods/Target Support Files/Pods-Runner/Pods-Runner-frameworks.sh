...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_animation_set/flutter_animation_set.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/native_mixpanel/native_mixpanel.framework"
