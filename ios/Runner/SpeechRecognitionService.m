...
#define API_KEY @"AIzaSyDVpFHycTb6uF4DnkoLhNjFSgJlyvEhJaY"
...
- (void)streamAudioData:(NSData *)audioData languageCode:(NSString *)code withCompletion:(SpeechRecognitionCompletionHandler)completion {
  ...
  if (!_streaming) {
    ...
    recognitionConfig.languageCode = [code stringByReplacingOccurrencesOfString:@"_" withString:@"-"];
