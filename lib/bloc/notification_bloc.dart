...
class NotificationBloc {
  ...
  String getDays() {
    ...
    if (editedReminder.weekdays[Reminder.MONDAY]) {
      days = Reminder.MONDAY;
    }
    if (editedReminder.weekdays[Reminder.TUESDAY]) {
      days += ", ${Reminder.TUESDAY}";
    }
    if (editedReminder.weekdays[Reminder.WEDNESDAY]) {
      days += ", ${Reminder.WEDNESDAY}";
    }
    if (editedReminder.weekdays[Reminder.THIRSDAY]) {
      days += ", ${Reminder.THIRSDAY}";
    }
    if (editedReminder.weekdays[Reminder.FRIDAY]) {
      days += ", ${Reminder.FRIDAY}";
    }
    if (editedReminder.weekdays[Reminder.SATURDAY]) {
      days += ", ${Reminder.SATURDAY}";
    }
    if (editedReminder.weekdays[Reminder.SUNDAY]) {
      days += ", ${Reminder.SUNDAY}";
    }
    return days;
  }

  bool getWeekSwitch() {
    return editedReminder.repeatWeekly;
  }

  TimeOfDay getTimeDay() {
    return editedReminder.time;
  }
